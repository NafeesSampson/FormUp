...
fun AddPlayerScreen(
    ...
    fun save() {
        ...
        val positionError =
            if (form.position.isBlank()) "Pick a position" else null
                ...
                SectionCard(
                    ...
                    Row(
                        ...
                        Column(Modifier.weight(1f)) {
                            ...
                            DateTimeField(
                                value = form.dateOfBirth.ifBlank { "dd MMM yyyy" },
                ...
                TextButton(
                    onClick = {
                        ...
                        if (millis != null) {
                            ...
                            update { state ->
                                state.copy(dateOfBirth = formatted)
                            }
                        }
